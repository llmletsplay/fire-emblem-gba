-- socketserver.lua (Port 8890 for parallel instance)  ── TCP control of mGBA + CAP screenshot + READRANGE command
...
--  CONFIG -----------------------------------------------------------------
--------------------------------------------------------------------------
local LISTEN_PORT   = 8890   -- TCP port for Python client
