-- socketserver.lua (Port 8889 for parallel instance)  ── TCP control of mGBA + CAP screenshot + READRANGE command
...
--  CONFIG -----------------------------------------------------------------
--------------------------------------------------------------------------
local LISTEN_PORT   = 8889   -- TCP port for Python client
